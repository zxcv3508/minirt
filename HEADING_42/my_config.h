...
/* 생성할 헤더파일의 이름을 적어주세요. */
#define HEADER_NAME "minirt.h"

/* 사용할 헤더파일들을 "" 사이에 적어주세요 공백(space)로 구분하여 적어주세요.
** 사용자 헤더파일을 적을 때 쌍따옴표앞에 역슬래시를 붙여주세요 ( " -> \") */
#define LIB "<stdio.h> <math.h> <unistd.h> <stdlib.h> <fcntl.h> <limits.h> <string.h> \"libft.h\" \"get_next_line.h\" \"mlx.h\""

/* 사용할 매크로를 적어주세요 여러개가 있다면 ',' 로 구분해 주세요
** ex) #define MECRO "BUFFER_SIZE 32, MAX 1024"
** 쌍따옴표앞에 역슬래시를 붙여주세요 STR \"hello\" ( " -> \") */
#define MACRO "FALSE 0, TRUE 1, KEY_D 2, KEY_A 0, KEY_ESC 53, SP 1, PL 2, TR 3, SQ 4, SY 5"
